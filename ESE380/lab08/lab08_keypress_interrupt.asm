...
;*			ESE 380
;*			Section 3 Bench 01
;*			LABORATORY 8: External and Internal Interrupts
;*			Design Task 1
;*
;* lab08_keypress_interrupt.asm
;* 	
;* DESCRIPTION
;*	A program that constantly multiplexes LEDs displays
;*	and utilizes an interrupt subroutine "keypress_isr"
;*	to detect PIND3 input to left shift displays.
;*
;* inputs: 
...
main:
	...
	call mux_display	;display dig0/1/2
	rjmp main	
...
keypress_isr:
	...
	ldi r16,100     ;wait var x 0.1ms for debounce to go away
	call var_delay

	;clear FF
    cbi PORTD, 6     ;generate a negative pulse on pin 0 of port D
    sbi PORTD, 6     ;to clear the flip-flop
